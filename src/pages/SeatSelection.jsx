  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-orange-100 pt-16 md:pt-20 px-4">
      ...
      >
        ...
        {/* Booking Summary */}
        <motion.div
          className="w-full p-6 bg-white bg-opacity-90 rounded-xl shadow-2xl mt-4 mb-4"
          initial={{ y: 50 }}
          animate={{ y: 0 }}
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              <h3 className="text-md font-semibold text-orange-900">
                Selected Seats: <span className="text-orange-600 font-medium">{selectedSeats.join(', ') || 'None'}</span>
              </h3>
              <h3 className="text-md font-semibold text-orange-900">
                Total Price: <span className="text-orange-600 font-medium">₹{selectedSeats.length * seatPrice}</span>
              </h3>
            </div>
            <motion.button
              className={`px-4 py-2 rounded-xl text-white text-md font-medium shadow-lg ${selectedSeats.length === 0
